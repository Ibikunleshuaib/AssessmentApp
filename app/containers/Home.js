    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <View>
                    <Text style={{fontWeight: 'bold', fontSize: 23}}>Current Time in Lagos Nigeria</Text>
                    <Text style={{fontWeight: 'bold', fontSize: 23, textAlign: 'center', marginTop: 20, color:'#00BE4D',}}>{dataToBeUsed}</Text>
                </View>
                <View>
                </View>
            </View>
